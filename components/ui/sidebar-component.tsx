    ...
    <div className="aspect-[24/24] grow min-h-px min-w-px overflow-clip relative shrink-0">
      <div className="absolute aspect-[24/16] left-0 right-0 top-1/2 -translate-y-1/2">
        <svg className="block size-full" fill="none" viewBox="0 0 24 16">
          <g>
            <path d={svgPaths.p36880f80} fill="#F72585" />
            <path d={svgPaths.p355df480} fill="#F72585" />
            <path d={svgPaths.pfa0d600} fill="#F72585" />
          </g>
        </svg>
      </div>
    </div>
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex items-center p-1 w-full">
        ...
        <div className="px-2 py-1">
          <div className="font-bold text-[18px] text-[#F72585] tracking-widest uppercase">
            Atlas
          </div>
        </div>
      </div>
...
function AvatarCircle() {
  return (
    <div className="relative rounded-full shrink-0 size-8 bg-gradient-to-tr from-[#3A0CA3] to-[#F72585]">
      <div className="flex items-center justify-center size-8">
        <UserIcon size={16} className="text-white" />
      </div>
      <div
        aria-hidden="true"
        className="absolute inset-0 rounded-full border-2 border-[#560BAD] pointer-events-none"
      />
    </div>
  );
}
function SearchContainer({ isCollapsed = false }: { isCollapsed?: boolean }) {
  ...
  return (
    ...
    >
      <div
        className={`bg-[#0d0d12] border border-[#560BAD]/50 h-10 relative rounded-2xl flex items-center transition-all duration-500 ${
      ...
      >
        ...
        >
          <div className="size-8 flex items-center justify-center">
            <SearchIcon size={16} className="text-[#B5179E]" />
          </div>
        </div>
        <div
          ...
          <div className="flex flex-col justify-center size-full">
            <div className="flex flex-col gap-2 items-start justify-center pr-2 py-1 w-full">
              <input
                ...
                className="w-full bg-transparent border-none outline-none text-[14px] text-white placeholder:text-[#560BAD] leading-[20px] font-mono"
      ...
      sections: [
        {
          title: "System Status",
          items: [
            { icon: <View size={16} className="text-[#F72585]" />, label: "Overview", isActive: true },
            {
              icon: <Dashboard size={16} className="text-[#F72585]" />,
            ...
            {
              icon: <ChartBar size={16} className="text-[#F72585]" />,
              label: "Operations",
              hasDropdown: true,
              children: [
                { label: "Uptime" },
        ...
        },
        {
          ...
          items: [
            {
              icon: <Report size={16} className="text-[#F72585]" />,
              label: "Anomaly Detection",
              hasDropdown: true,
              children: [
                { label: "Threats: 0" },
                { label: "System Health: 98%" },
              ],
            },
            {
              icon: <StarFilled size={16} className="text-[#F72585]" />,
...
function IconNavButton({
  ...
  return (
    <button
      type="button"
      className={`flex items-center justify-center rounded-2xl size-12 min-w-12 transition-all duration-300
        ${isActive ? "bg-[#7209B7] text-white shadow-[0_0_15px_rgba(114,9,183,0.5)] border border-[#B5179E]" : "bg-[#0d0d12]/50 hover:bg-[#3A0CA3]/40 text-[#B5179E] border border-transparent hover:border-[#7209B7]"}`}
      style={{ transitionTimingFunction: softSpringEasing }}
      onClick={onClick}
    >
      {children}
...
function IconNavigation({
  ...
  return (
    <aside className="bg-[#0a0a0f] flex flex-col gap-4 items-center py-6 px-3 w-20 h-screen border-r border-[#560BAD]/40 shadow-[4px_0_24px_rgba(58,12,163,0.15)] relative z-20">
      {}
      <div className="mb-6 size-12 flex items-center justify-center bg-[#3A0CA3] rounded-2xl shadow-[0_0_20px_rgba(247,37,133,0.3)] border border-[#F72585]">
    ...
    return (
      <div className="w-full flex justify-center transition-all duration-500" style={{ transitionTimingFunction: softSpringEasing }}>
        <button
          ...
          className="flex items-center justify-center rounded-2xl size-10 min-w-10 transition-all duration-500 hover:bg-[#3A0CA3]/30 text-[#F72585]"
          style={{ transitionTimingFunction: softSpringEasing }}
    ...
    <div className="w-full overflow-hidden transition-all duration-500" style={{ transitionTimingFunction: softSpringEasing }}>
      <div className="flex items-center justify-between">
        <div className="flex items-center h-10">
          <div className="px-2 py-1">
            <div className="font-bold text-[18px] text-white tracking-wide">
              {title}
            </div>
          </div>
        </div>
        <div className="pr-1">
          <button
            type="button"
            onClick={onToggleCollapse}
            className="flex items-center justify-center rounded-2xl size-10 min-w-10 transition-all duration-300 hover:bg-[#3A0CA3]/30 text-[#F72585]"
            style={{ transitionTimingFunction: softSpringEasing }}
...
export function SidebarComponent({ onSectionChange, activeSection }: { onSectionChange: (s: string) => void, activeSection: string }) {
  ...
  return (
    <div className="flex flex-row h-screen">
      ...
      <aside
        className={`bg-[#0d0d12]/95 backdrop-blur-xl flex flex-col gap-6 items-start p-6 border-r border-[#560BAD]/30 transition-all duration-500 h-screen shadow-[4px_0_24px_rgba(0,0,0,0.5)] relative z-10 ${
          isCollapsed ? "w-20 min-w-20 !px-0 justify-center" : "w-[300px]"
        }`}
        style={{ transitionTimingFunction: softSpringEasing }}
      >
        ...
        {!isCollapsed && (
          <div className="w-full mt-auto pt-4 border-t border-[#560BAD]/30">
            <div className="flex items-center gap-3 px-3 py-2 bg-[#3A0CA3]/10 rounded-2xl border border-[#560BAD]/20">
              <AvatarCircle />
              <div className="flex flex-col">
                <div className="font-bold text-[14px] text-white">Vihaan</div>
                <div className="text-[12px] text-[#B5179E] font-mono">System Admin</div>
              </div>
              <button
                type="button"
                className="ml-auto size-8 rounded-xl flex items-center justify-center hover:bg-[#7209B7]/40 text-[#F72585] transition-colors"
                aria-label="More"
              >
                <ChevronDownIcon size={16} />
              </button>
...
function MenuItem({
  ...
  return (
    ...
    >
      <div
        className={`rounded-2xl cursor-pointer transition-all duration-300 flex items-center relative ${
          item.isActive 
            ? "bg-[#7209B7]/20 border border-[#7209B7]/50 shadow-[inset_0_0_12px_rgba(114,9,183,0.3)]" 
            : "hover:bg-[#3A0CA3]/20 border border-transparent hover:border-[#560BAD]/30"
        } ${isCollapsed ? "w-12 min-w-12 h-12 justify-center p-0" : "w-full h-12 px-4 py-2"}`}
        style={{ transitionTimingFunction: softSpringEasing }}
        onClick={handleClick}
        title={isCollapsed ? item.label : undefined}
      >
        <div className={`flex items-center justify-center shrink-0 ${item.isActive ? "text-[#F72585]" : "text-[#B5179E]"}`}>
          {item.icon}
        </div>
        <div
          className={`flex-1 relative transition-opacity duration-500 overflow-hidden ${
          ...
          style={{ transitionTimingFunction: softSpringEasing }}
        >
          <div className={`font-mono text-[13px] leading-[20px] truncate ${item.isActive ? "text-white font-bold" : "text-gray-300"}`}>
            {item.label}
          </div>
        </div>
        {item.hasDropdown && (
          ...
          >
            <ChevronDownIcon
              size={16}
              className={`${item.isActive ? "text-[#F72585]" : "text-[#560BAD]"} transition-transform duration-500`}
              style={{
...
function SubMenuItem({ item, onItemClick }: { item: MenuItemT; onItemClick?: () => void }) {
  return (
    <div className="w-full pl-[52px] pr-2 py-[2px]">
      <div
        className="h-9 w-full rounded-xl cursor-pointer transition-colors hover:bg-[#3A0CA3]/20 flex items-center px-3 py-1 group"
        onClick={onItemClick}
      >
        <div className="w-1.5 h-1.5 rounded-full bg-[#560BAD] group-hover:bg-[#F72585] mr-3 transition-colors" />
        <div className="flex-1 min-w-0">
          <div className="font-mono text-[12px] text-gray-400 group-hover:text-white leading-[18px] truncate transition-colors">
            {item.label}
          </div>
        </div>
      </div>
    ...
    <div className="flex flex-col w-full gap-1">
      ...
      >
        <div className="flex items-center h-8 px-4">
          <div className="font-bold text-[11px] text-[#B5179E] uppercase tracking-widest">
            {section.title}
          </div>
        </div>
      </div>
        ...
        return (
          <div key={itemKey} className="w-full flex flex-col">
            ...
            {isExpanded && item.children && !isCollapsed && (
              <div className="flex flex-col gap-0.5 mt-1 mb-2 border-l border-[#560BAD]/30 ml-6">
